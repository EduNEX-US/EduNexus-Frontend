...
export default function Login(){
    ...
    return <Section cn='h-screen w-2/2 flex'>
            <Div cn='h-full w-3/5 transition-transform ease-out duration-500'>
                <img className='h-full transition-transform ease-out duration-700' src={graffiti}></img>
            </Div>
            <Div cn='h-full w-2/5 flex flex-col items-center justify-center bg-white'>
                <Div cn='h-1/4 w-2/3 flex justify-center items-center animate-bounce'>
                    <img src={edu} className='h-full contain'></img>
                </Div>
                <Div cn='h-2/3 w-2/3 bg-black rounded-xl flex flex-col justify-start items-center bg-purple-400'>
                    <Div cn='h-1/3 w-3/4 flex flex-col justify-center items-start'>
                        <Input labelCN='text-white font-bold text-xl mb-2' labelTxt='ID' inpCN='inset-ring-2 outline-none inset-ring-black rounded-xl text-purple-400 bg-white w-full p-2' type='text' inpTxt='2541x89rft...' forName='id' ref={idRef}></Input>
                    </Div>
                    <Div cn='h-1/3 w-3/4 flex flex-col justify-center items-start'>
                        <label className='text-white font-bold text-xl mb-2'>Password</label>
                    ...
                    <Div cn='h-1/8 w-3/4 flex justify-around'>
                        <label className='flex items-center gap-2 accent-purple-600'>
                    ...
                    <Div cn='h-1/4 w-2/4 mt-4'>
                        <Button cn='w-full bg-white text-purple-400 hover:text-white font-bold hover:bg-purple-400 hover:shadow-sm hover:shadow-black transition transition-all duration-400 ease cursor-pointer text-xl p-2 rounded-xl' onClick={()=>{handleLogin(); }}>Login</Button>
                    </Div>
                </Div>
            </Div>
        </ Section>
