...
export default function Login(){
    ...
    return <Section cn='h-screen w-2/2 flex'>
            ...
            <Div cn='h-full w-2/5 flex flex-col items-center justify-center bg-black'>
                ...
                <Div cn='h-2/3 w-2/3 bg-black rounded-xl flex flex-col justify-start items-center bg-gradient-to-br from-lime-400 via-lime-200 to-white animate-gradient'>
                    ...
                    <Div cn='h-1/8 w-3/4 flex justify-around'>
                        <label className='flex items-center gap-2 accent-lime-400'>
